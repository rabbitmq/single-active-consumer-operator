...
RUN echo "single-active-consumer-operator:x:1001:" > /etc/group && \
    echo "single-active-consumer-operator:x:1001:1001::/home/single-active-consumer-operator:/usr/sbin/nologin" > /etc/passwd
